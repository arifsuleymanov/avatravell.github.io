<?php 
	if(isset($_POST["submit"])){
		...
		$user_gabala_hotel = $_POST['user_gabala_hotel'];
		$user_sheki_hotel = $_POST['user_sheki_hotel'];
		...
		$message .= "My hotel in Gabala is ".$user_gabala_hotel.". ";
		$message .= "My hotel in Sheki is ".$user_sheki_hotel.". ";
